...
typedef enum FSBANK_RESULT
{
    ...
    FSBANK_WARN_IGNORED_OPTIMIZESAMPLERATE, /* FSBANK_BUILD_OPTIMIZESAMPLERATE flag ignored: MP2 and MP3 formats, and the USEBASICHEADERS flag make this option irrelevant. */
...
constexpr const char* FSBANK_RESULT_TOSTRING(FSBANK_RESULT e) throw()
{
    switch (e)
    {
    case FSBANK_RESULT::FSBANK_OK: return "FSBANK_OK";
    case FSBANK_RESULT::FSBANK_ERR_CACHE_CHUNKNOTFOUND: return "FSBANK_ERR_CACHE_CHUNKNOTFOUND";
    case FSBANK_RESULT::FSBANK_ERR_CANCELLED: return "FSBANK_ERR_CANCELLED";
    case FSBANK_RESULT::FSBANK_ERR_CANNOT_CONTINUE: return "FSBANK_ERR_CANNOT_CONTINUE";
    case FSBANK_RESULT::FSBANK_ERR_ENCODER: return "FSBANK_ERR_ENCODER";
    case FSBANK_RESULT::FSBANK_ERR_ENCODER_INIT: return "FSBANK_ERR_ENCODER_INIT";
    case FSBANK_RESULT::FSBANK_ERR_ENCODER_NOTSUPPORTED: return "FSBANK_ERR_ENCODER_NOTSUPPORTED";
    case FSBANK_RESULT::FSBANK_ERR_FILE_OS: return "FSBANK_ERR_FILE_OS";
    case FSBANK_RESULT::FSBANK_ERR_FILE_NOTFOUND: return "FSBANK_ERR_FILE_NOTFOUND";
    case FSBANK_RESULT::FSBANK_ERR_FMOD: return "FSBANK_ERR_FMOD";
    case FSBANK_RESULT::FSBANK_ERR_INITIALIZED: return "FSBANK_ERR_INITIALIZED";
    case FSBANK_RESULT::FSBANK_ERR_INVALID_FORMAT: return "FSBANK_ERR_INVALID_FORMAT";
    case FSBANK_RESULT::FSBANK_ERR_INVALID_FORMAT_PCMBITS: return "FSBANK_ERR_INVALID_FORMAT_PCMBITS";
    case FSBANK_RESULT::FSBANK_ERR_INVALID_PARAM: return "FSBANK_ERR_INVALID_PARAM";
    case FSBANK_RESULT::FSBANK_ERR_MEMORY: return "FSBANK_ERR_MEMORY";
    case FSBANK_RESULT::FSBANK_ERR_UNINITIALIZED: return "FSBANK_ERR_UNINITIALIZED";
    case FSBANK_RESULT::FSBANK_ERR_WRITER_FORMAT: return "FSBANK_ERR_WRITER_FORMAT";
    case FSBANK_RESULT::FSBANK_WARN_CANNOTLOOP: return "FSBANK_WARN_CANNOTLOOP";
    case FSBANK_RESULT::FSBANK_WARN_IGNORED_OPTIMIZESAMPLERATE: return "FSBANK_WARN_IGNORED_OPTIMIZESAMPLERATE";
    case FSBANK_RESULT::FSBANK_WARN_IGNORED_FILTERHIGHFREQ: return "FSBANK_WARN_IGNORED_FILTERHIGHFREQ";
    case FSBANK_RESULT::FSBANK_WARN_IGNORED_DISABLESEEKING: return "FSBANK_WARN_IGNORED_DISABLESEEKING";
    case FSBANK_RESULT::FSBANK_WARN_IGNORED_DONTINTERLEAVE: return "FSBANK_WARN_IGNORED_DONTINTERLEAVE";
    case FSBANK_RESULT::FSBANK_ERR_ENCODER_FILE_NOTFOUND: return "FSBANK_ERR_ENCODER_FILE_NOTFOUND";
    case FSBANK_RESULT::FSBANK_ERR_ENCODER_FILE_BAD: return "FSBANK_ERR_ENCODER_FILE_BAD";
